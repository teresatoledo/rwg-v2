...
<div className="flex items-center justify-center pb-10 mx-auto relative h-screen">
  <div className='flex flex-col justify-center items-center gap-2 pb-4 min-[1024px]:mt-20 '>
    <h3 className='sm:text-xl text-center sm:px-10 mx-2 sm:mt-3 h-20 border-2 border-blue-300 flex just items-center rounded-md'>
      Una herramienta para cuando tienes la motivación, pero te faltan las ideas.
    </h3>
    <div className='flex flex-col sm:flex-row gap-3 sm:gap-10 py-3'>
    ...
    <Button className='mt-3' onClick={() => router.push('/entrenar')}>Entrenar</Button>
  </div>      
</div>
